...
class PlaylistImporterModal extends React.Component {
    ...
    handleSubmit = () => {
        ...
        Axios.post('/api/playlist/create/deezer', { Name, IsPublic, DeezerId: ParsedDeezerUrl })
            .then((res) => {
    ...
    onPlaylistUrlChange = (event) => {
        ...
        if (Matches) {
            if (Matches.length === 1) {
                ...
                if (!Number.isNaN(parsed)) DeezerId = parsed;
            }
        }
    ...
    render() {
        const { PlaylistDeezerUrl, IsPublic, ParsedDeezerUrl, IsLoading, Name } = this.state;
        ...
        return (
            <Modal show onHide={this.closeModal}>
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Form.Group controlId="PlaylistDzUrl">
                            ...
                            <Form.Control
                                value={PlaylistDeezerUrl}
                                onChange={this.onPlaylistUrlChange}
                ...
                <Modal.Footer>
                    <Button
                        variant="primary"
                        disabled={ParsedDeezerUrl === undefined}
